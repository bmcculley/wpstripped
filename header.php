...
<?php do_action( 'before' ); ?>
	<header id="header" role="banner">
		...
		<nav id="access" class="main-navigation" role="navigation">
			<h1 class="assistive-text section-heading"><?php _e( 'Menu', 'wpstripped' ); ?></h1>
			<div class="skip-link screen-reader-text"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'wpstripped' ); ?>"><?php _e( 'Skip to content', 'wpstripped' ); ?></a></div>
